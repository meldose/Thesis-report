...
\begin{figure}[h]
    ...
    \label{fig1.Photoneo Cmaera}
\end{figure}\\
The below figure shows the results that is obtained while pciking the items in an moving conveyor belt speed (m/s) with respect to Sucees Rates.
\begin{figure}[h]
    \centering
    ...
    \label{fig1.Photoneo Cmaera}
\end{figure}\\
The below figure shows the results that is obtained while pciking the items in an moving conveyor belt speed (m/s) with respect to Avg pick up time.\\
\begin{figure}[h]
    \centering
    ...
    \label{fig1.Photoneo Cmaera}
\end{figure}\\
The below figure shows the results that is obtained while pciking the items in an Avg pick up time vs Lighting conditions.\\
\begin{figure}[h]
    \centering
