...
\begin{enumerate}
    ...
    \item Use PhoXi Control's marker pattern to save calibration. We can use this setting as a custom scanning profile in Vision System´s Space by adding a triggering item for the sensor at the marker pattern export photo's origin.[21]
