...
v si the velocity / calibrated custom velocity\\
t is change in time \\
...
The below figure shows the volume/area in which the Photoneo Camera is possible to scan the items and get the object poses. 
