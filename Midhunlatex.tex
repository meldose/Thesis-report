...
\begin{center}
    ...
    {Verfolgung eines Förderbandes mit einem Roboter unter Verwendung einer Bildverarbeitungskamera}
    
    \vspace{0.5 cm}
    
    \textbf{Tracking conveyor belt with robot using a machine vision camera}
...
\end{center}
    ...
    \vspace{0.5 cm}
     ...
     The Deggendorf Institute of Technology supervises an examination paper with the topic of\textbf{ Tracking conveyor belt with robot using a machine vision camera}
