...
\begin{figure}[h]
    \centering
    \includegraphics[width=7cm]{Thesis-report/Figures/conveyor_speed vs Robot tcp speed.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=7cm]{Thesis-report/Figures/conveyor_speed vs success_rates.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=7cm]{Thesis-report/Figures/conveyor_speed vs avg pick_up_time.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=7cm]{Thesis-report/Figures/Picking_time vs item_type.png}
