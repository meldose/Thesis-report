...
A coordinate system is often specified by the user or developer, but it can exist anywhere in the world. WCS makes it simpler to explain the locations of other things or items in that specific area. we can put it anywhere in your room or factory. Origin placement is typically done at the edge of a group or a room's corner.[24]\\
