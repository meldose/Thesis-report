...
Triangulation is used in photogrammetry to intersect particular points within 2D images based on the angles at which those points can be found. The size, quantity, and quality of the item's images all have a big impact on creating an appropriate 3D model . 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5cm]{Thesis-report/Figures/new_Normals.png}
    \caption{Normals}
    \label{fig:normals}
\end{figure}
...
The below eqautions are taken from this journal: \cite{ref21}
\[
V_c = V_r 
\]
...
The below equation are taken from this journal: \cite{ref26}
\begin{align} 
\[
