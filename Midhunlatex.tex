...
\begin{figure}[h]
    \centering
    \includegraphics[width=13cm]{Thesis-report/Figures/scanning_Mrile.jpg} 
    \caption{Scanning Mrile [2] }
    \label{fig1.Photoneo Cmaera}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=10cm]{Thesis-report/Figures/flowchart.png}  
    \caption{flow Chart}
    \label{fig1.Photoneo Cmaera}
\end{figure}
\newpage
