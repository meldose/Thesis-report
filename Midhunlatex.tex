...
where: base Pobj: The robot base frame's object point; base  Heam: The matrix used to convert the robot base frame from the stereo camera frame
 Finally, the above two equations are combined to give the overall transformation equation for the entire system (i.e., (6)).  For a robotic system with an eye-to-hand arrangement, equation (6) shows the series of coordinate transformations from the image plane to the robot base frame.
