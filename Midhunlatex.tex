...
The above figure shows the volume/area in which the Photoneo Camera can scan items and determine object poses. The top view shows the maximum field of view (FOV) reachable by the camera for object coordinate acquisition, which extends up to 15 m.

\chapter{\section{\mbox{Results and Discussions }}{{\normalfont\fontsize{14}{16}\bfseries}}
\subsection{Robot TCP Speed vs Conveyor Speed}
The below figure shows the results that is obtained while picking the items on a moving conveyor belt speed (m/s) relative to the Robot speed.\\
\label{Literature}
\begin{figure}[h]
    \centering
...
The below figure shows the results obtained while placing the items on a moving conveyor belt speed (m/s) relative to the Avg pick-up time.\\
\begin{figure}[h]
    \centering
...
\begin{figure}[h]
    ...
    \label{fig1.Photoneo Cmaera}
\end{figure} \\
The figure above shows the results that are obtained while placing the items include the trapezoid and pipe with an average pick-up time vs. lighting conditions.\\
