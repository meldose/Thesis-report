...
When we pass the object through the conveyor belt , there is change in position in the X axis as this is an linear motion of movement . The change in the postion of the object need to be trasnfered to the robot , so that robot can understand where should i need to come and pick the item from the conveyor belt. This can be cacualtes by using the following equtaion:
\[
X_0 = X + v \cdot t
\]
where the X0 is the change in the postion of the object \\
